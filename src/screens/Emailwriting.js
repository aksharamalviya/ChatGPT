...
return (
  <Animatable.View
    ...
    <Text style={{marginLeft:35,fontSize:20,color:'#DD8232',fontWeight:'500'}}>Email Writing</Text>
  </TouchableOpacity>
  ...
  <View style={{alignSelf:'flex-start',flexDirection:'row'}}>
      ...
      <Lottie source={require('../assets/Images/emaillottie2.json')}
     useRef={animationRef}
      autoPlay={true}
   ...
   <View style={{marginLeft:10,marginTop:10,backgroundColor:'#F9B463',borderRadius:10,paddingLeft:7,padding:2}}>
    <Text style={{}}>Create Email On just about anything !</Text>
   </View>
   </View>
  </View>
...
<TouchableOpacity style={styles.button} onPress={() => handleSend()}>
    ...
    <ScrollView style={{marginHorizontal:10,padding:8,borderRadius:10,backgroundColor:'#F9B463',height:400}}>
