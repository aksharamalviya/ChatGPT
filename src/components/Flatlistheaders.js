import { FlatList, Image, StyleSheet, Text, TouchableOpacity, View,Modal, TextInput, Alert,ScrollView } from 'react-native'
...
const renderItem = ({item}) => {
    return(
      ...
      animation="slideInDown" iterationCount={5} direction="alternate"
       style={{borderRadius:10,borderColor:'#7E1AD6',margin: 5,flex:1,width:'90%',marginHorizontal:20}}>
        <TouchableOpacity style={{}}
        onPress={() => navigation.navigate(item.navigation)}
        >
            
            <Image source={item.img} style={{ height: 170, width: 320,resizeMode:'stretch' }} />
...
// const renderItem = ({item}) => {
//   return(
//     <View style={{borderRadius:10,flex:1,width:'100%',alignSelf:'center'}}>
//       <TouchableOpacity onPress={() => navigation.navigate(item.navigation)} style={{}}>
//       <Image source={item.img} style={{height:180,width:340,resizeMode:'cover'}}/>
//       </TouchableOpacity>
//     </View>
//   )
// }
